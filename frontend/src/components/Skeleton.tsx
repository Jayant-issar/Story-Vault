...
function Skeleton() {
  return (
    <div className=" min-h-screen p-10 pt-10" >
        ...
        <div role="status" className="max-w-md m-2 p-4 space-y-4 border border-gray-200 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700">
